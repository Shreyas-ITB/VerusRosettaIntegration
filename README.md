...
- You can also change the data in the configuration files according to your preference.
...
![Video of testing Rosetta API Integration with Mesh-CLI](https://github.com/Shreyas-ITB/VerusRosettaIntegration/blob/main/resources/CLITesting.gif)
